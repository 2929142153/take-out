...
*/
  ...
  export const RECET_USER_INFO = 'recet_user_info' //清除用户信息

  export const RECEIVE_FOODS = 'receive_foods' // 接收商品数组
  ...
  export const RECEIVE_SEARCH_SHOPS = 'receive_search_shops' // 接受搜索商家列表
